...
set CLASSPATH=%APP_HOME%\lib\com.nate.eddiebot.EddieBot-1.0-all.jar

@rem Execute com.nate.eddiebot.EddieBot
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COM_NATE_EDDIEBOT_EDDIE_BOT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
