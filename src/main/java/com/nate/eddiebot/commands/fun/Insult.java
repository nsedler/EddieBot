...
public class Insult extends Command {
    ...
    // huuuuge list of insult, from bbot
    private String insults[] = new String[] { "Yo Mama so fat she sued Xbox 360 for guessing her weight.",
            ...
            "Yo Mama so fat she's on both sides of the family.", "Yo Mama so fat that even Dora couldn't explore her.",
            ...
            ":eggplant: :eggplant: :eggplant:", ":cheese: :cheese: :cheese:",
            "Don't let your mind wander -- it's too little to be let out alone.",
            "Don't thank me for insulting you. It was my pleasure.",
            "Don't you realize that there are enough people to hate in the world already without your working so hard to give us another?",
            "Everyone is gifted. Some open the package sooner.", "Fat? You're not fat, you're just ... fat.",
            "Forgot to pay his brain bill.", "Grasp your ears firmly and remove your head from your ass.",
            "Has the IQ of lint.", "Talk is cheap, but so are you.", "has more faces than Mount Rushmore.",
            "has one brain cell, and it is fighting for dominance.", "is depriving a village somewhere of an idiot.",
            "is living proof that man can live without a brain!", "is so short his hair smell like feet",
            ...
            "You're the reason the gene pool needs a lifeguard.", "A guy with your IQ should have a low voice too!",
            ...
            "Well I could agree with you, but then we'd both be wrong.", "You're so fat, you could sell shade.",
            ...
            "If I wanted to hear from an asshole, I'd fart.", "You're so fat you need cheat codes to play Wii Fit",
            "You're so ugly, when you got robbed, the robbers made you wear their masks.",
            "Do you still love nature, despite what it did to you?", "You are proof that evolution CAN go in reverse.",
            ...
            "I heard you went to a haunted house and they offered you a job.", "You look like a before picture.",
            "If your brain was made of chocolate, it wouldn't fill an M&M.",
            "Aww, it's so cute when you try to talk about things you don't understand.",
            "I heard your parents took you to a dog show and you won.",
            "You stare at frozen juice cans because they say, \"concentrate\".",
            "You're so stupid you tried to wake a sleeping bag.", "Am I getting smart with you? How would you know?",
            ...
            "Ordinarily people live and learn. You just live.", "Did your parents ever ask you to run away from home?",
            "I heard you took an IQ test and they said your results were negative.",
            "You're so ugly, you had tinted windows on your incubator.", "Don't you need a license to be that ugly?",
            ...
            "I may be fat, but you're ugly, and I can lose weight.", "I was pro life before I met you.",
            ...
            "I'd hit you but we don't hit girls around here.", "Dumbass.", "Bitch.", "Retard.",
            "I'd give you a nasty look but you've already got one.", "If I wanted a bitch, I'd have bought a dog.",
            ...
            "You're so fat Mount Everest tried to climb you.", "You're so fat you can't even jump to a conclusion.",
            "You're so fat you can't fit in any timeline.", "You're so fat you can't fit in this joke.",
            "You're so fat you don't skinny dip, you chunky dunk.", "You're so fat you fell in love and broke it.",
            ...
            "You're so fat you'd have to go to Sea World to get baptized.", "You're so fat you have your own zip code.",
            "You're so fat you have more rolls than a bakery.",
            "You're so fat you don't have got cellulite, you've got celluheavy.",
            "You're so fat you influence the tides.", "You're so fat you jumped off the Grand Canyon and got stuck.",
            "You're so fat that you laid on the beach and Greenpeace tried to push you back in the water.",
            "You're so fat you leave footprints in concrete.", "You're so fat you need GPS to find your asshole.",
            ...
            "If your IQ was 3 points higher, you'd be a rock.", "I would insult you but nature did a better job.",
            ...
            "I would agree with you but then we would both be wrong.", "I bite my thumb at you, sir.",
    ...
    protected void execute(BetterMessageEvent event) {
        ...
        try{
            ...
            if (loser.getId().equals("185063150557593600") || loser.getId().equals("503355821166690306")) {
                event.reply(event.getAuthor().getName() + ", " + insults[index]);
            } else {
                event.reply(loser.getName() + ", " + insults[index]);
            }
